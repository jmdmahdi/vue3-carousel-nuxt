...
- Initial commit ([8c0733c](https://github.com/jmdmahdi/vue3-carousel-nuxt/commit/8c0733c))

### 🩹 Fixes

- Fix non respect of standard .mjs file name and upgrade dependencies ([df0e2fb](https://github.com/jmdmahdi/vue3-carousel-nuxt/commit/df0e2fb))
- Remove alias esm resolution handled in 0.3.4 and update packages ([498ab60](https://github.com/jmdmahdi/vue3-carousel-nuxt/commit/498ab60))
- Fix linter ([96ab060](https://github.com/jmdmahdi/vue3-carousel-nuxt/commit/96ab060))

### 📖 Documentation

- Use new `nuxi module add` command in installation ([a07baa7](https://github.com/jmdmahdi/vue3-carousel-nuxt/commit/a07baa7))

### 🏡 Chore

- **release:** V1.1.0 ([7d23e2c](https://github.com/jmdmahdi/vue3-carousel-nuxt/commit/7d23e2c))
- **release:** V1.1.1 ([22d1aa4](https://github.com/jmdmahdi/vue3-carousel-nuxt/commit/22d1aa4))
- **release:** V1.1.2 ([59e763a](https://github.com/jmdmahdi/vue3-carousel-nuxt/commit/59e763a))
- **release:** V1.1.3 ([2dee9f0](https://github.com/jmdmahdi/vue3-carousel-nuxt/commit/2dee9f0))
- **release:** V1.1.4 ([22be3eb](https://github.com/jmdmahdi/vue3-carousel-nuxt/commit/22be3eb))
- **release:** V1.1.5 ([9466c17](https://github.com/jmdmahdi/vue3-carousel-nuxt/commit/9466c17))
